        ...
        <div class="content" id="content">
            ...
            <section id="step1">
                <section class="section">
                    <div class="option" id="Individual" onclick="navigate('step1','step2')">
                        <img src="assets/icons/user.png" class="icon">
                    </div>
                    <div class="label">Individual</div>
                    <div class="option" id="Organizer" onclick="window.location.href='signup-organizer.php'">
                        <img src="assets/icons/building.png" class="icon">
                    </div>
            ...
            <section class="step" id="step2">
                <form class="formSection" action="create-account.php" method="post" id="signupForm">
                    ...
                    <section class="step" id="step2-2">
                        ...
                        <button type="button" class="buttonType1" id="signupButton" for="signupForm">Signup</button>
                    </section>
                </form>
            </section>
    </section>
